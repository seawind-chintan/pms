...
/**
 * WaterparkRechargesFixture
 *
 */
class WaterparkRechargesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'waterpark_recharges_ibfk_2' => ['type' => 'foreign', 'columns' => ['property_id'], 'references' => ['properties', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'waterpark_recharges_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'amount' => 1,
            'status' => 1,
            'created' => '2018-03-15 07:18:19',
            'modified' => '2018-03-15 07:18:19'
        ],
    ];
}
