...
class RoomsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'images' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'images_dir' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'room_occupancy' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'room_occupancy' => ['type' => 'index', 'columns' => ['room_occupancy'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'rooms_ibfk_4' => ['type' => 'foreign', 'columns' => ['room_occupancy'], 'references' => ['room_occupancies', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            ...
            'rooms_ibfk_3' => ['type' => 'foreign', 'columns' => ['property_id'], 'references' => ['properties', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'property_id' => 1,
            'status' => 1,
            'created' => '2018-02-19 07:49:06',
            'modified' => '2018-02-19 07:49:06'
        ],
    ];
}
