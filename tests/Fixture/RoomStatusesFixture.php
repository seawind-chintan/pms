...
class RoomStatusesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'room_statuses_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'status' => 1,
            'created' => '2018-02-14 09:33:14',
            'modified' => '2018-02-14 09:33:14'
        ],
    ];
}
