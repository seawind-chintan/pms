    ...
    public function isAuthorized($user)
    {
        ...
        if (isset($user['role']) && $user['role'] === 2) {
            ...
            $controller_array = array('Users','Properties','Rooms','RoomTypes',
                                        'Countries','States','Cities','Channels','Reservations', 'ReservationRooms', 'Members', 'UserServices', 'RoomOccupancies' , 'RoomPlans', 'RoomRates', 'Checkins', 'CheckinBillings', 'WaterparkPrices');
            $method_array = array();
