...
/**
 * WaterparkKotItemBilling Entity
 *
 * @property int $id
 * @property int $property_id
 * @property int $waterpark_kot_id
 * @property int $waterpark_kot_billing_id
