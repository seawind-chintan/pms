 ...
 *
 * @method \App\Model\Entity\WaterparkKotItem get($primaryKey, $options = [])
 * @method \App\Model\Entity\WaterparkKotItem newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\WaterparkKotItem[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\WaterparkKotItem|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\WaterparkKotItem patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\WaterparkKotItem[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\WaterparkKotItem findOrCreate($search, callable $callback = null, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class WaterparkKotItemsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('waterpark_kot_items');
