      ...
      <div class="box box-primary">
        ...
        <?= $this->Form->create($user, array('role' => 'form')) ?>
          ...
          <?php
            ...
            $selected = array();
            echo $this->Form->input('userdetail.state', array('onChange'=>'showFields(this.value)','label'=>'Select State','class' => 'form-control', 'options' => $statesoptions, 'selected' => $selected));
