...
//            echo $this->Form->input('restaurant_table_ids');
            ...
            echo $this->Form->input('restaurant_table_ids', ['options' => $table_array,'label' => 'Select Tables','multiple'=>'true','value'=>explode(',',$restaurantTableBooking->restaurant_table_ids)]);
            echo $this->Form->input('booking_date', ['empty' => true, 'default' => '', 'class' => 'datepicker form-control', 'type' => 'text','value'=> $this->Time->format($restaurantTableBooking->booking_date, 'd-M-Y')]);
