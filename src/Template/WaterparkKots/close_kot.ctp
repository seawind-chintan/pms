        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?= __('List of') ?> Waterpark Close Kots</h3>
                    <div class="box-tools">
                        <?php /* * ?>
                            ...
                            foreach ($waterparkKots as $waterparkKot): ?>
                                <tr>
                                    ...
                                    <td class="actions" style="white-space:nowrap">
                                        ...
                                        <?php //echo $this->Html->link(__('Modify'), ['action' => 'add-more/', $waterparkKot->id], ['class'=>'btn btn-info btn-xs']) ?>
                                        <?php echo $this->Html->link(__('View'), ['action' => 'view', $waterparkKot->id], ['class' => 'btn btn-info btn-xs']) ?>
                                        <?php echo $this->Html->link(__('Generate Bill'), ['controller'=>'waterpark-kot-billings', 'action' => 'generate_bill/', $waterparkKot->id], ['class'=>'btn btn-info btn-xs']) ?>
                                        <?php echo $this->Form->postLink(__('Cancel'), ['action' => 'kotcancel', $waterparkKot->id], ['confirm' => __('Confirm to Cancel this kot?'), 'class'=>'btn btn-danger btn-xs']) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
