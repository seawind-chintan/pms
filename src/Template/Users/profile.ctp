      ...
      <div class="box box-primary">
        ...
        <?= $this->Form->create($user, array('role' => 'form', 'type' => 'file')) ?>
          ...
          <?php
            ...
            echo $this->Form->input('user_detail.profile_pic', ['type' => 'file', 'required' => 'false']);

            echo $this->Html->image($this->Url->build('/webroot/img/uploads/userdetails/profile_pic/', true). $user->user_detail->profile_pic_dir . '/square_' . $user->user_detail->profile_pic, array('class' => 'user-image', 'alt' => 'User Image'));
