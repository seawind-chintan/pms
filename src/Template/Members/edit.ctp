        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6"><b>Residence</b>
                        <input type="checkbox" name="sameas" id="sameas" onclick="fill_address();">
                    ...
                    <div class="col-md-12">
                        <?php
                        echo $this->Form->input('images', ['type' => 'file']);
                        echo $this->Html->image($this->Url->build('/webroot/img/uploads/members/images/', true) . $member->images_dir . '/square_' . $member->images, array('class' => 'user-image', 'alt' => 'User Image','width'=>'100px'));
                        ?>
                    </div>
                    ...
                    <?php /*                     * ?>
                      ...
                      echo '<br>';
                      $service_array = explode(',',$member->services);
...
<script type="text/javascript">
    function fill_address()
    {
        ...
        if ($('#sameas').is(':checked'))
        {
            ...
            $('#' + set_val + 'address').val($('#' + get_val + 'address').val());
            $('#' + set_val + 'country').val($('#' + get_val + 'country').val());
            $('#' + set_val + 'state').val($('#' + get_val + 'state').val());
            $('#' + set_val + 'city').val($('#' + get_val + 'city').val());
            $('#' + set_val + 'pincode').val($('#' + get_val + 'pincode').val());
        } else
        {
            $('#' + set_val + 'address').val("<?php echo $member->res_address; ?>");
            $('#' + set_val + 'country').val("<?php echo $member->res_country; ?>");
            $('#' + set_val + 'state').val("<?php echo $member->res_state; ?>");
            $('#' + set_val + 'city').val("<?php echo $member->res_city; ?>");
            $('#' + set_val + 'pincode').val("<?php echo $member->res_pincode; ?>");
        }
    }
</script>
<script>
