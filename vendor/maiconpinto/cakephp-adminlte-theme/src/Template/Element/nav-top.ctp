    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown user user-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          ...
          <?php echo $this->Html->image($this->Url->build('/webroot/img/uploads/userdetails/profile_pic/', true). $current_user_details->user_detail->profile_pic_dir . '/square_' . $current_user_details->user_detail->profile_pic, array('class' => 'user-image', 'alt' => 'User Image')); ?>
          <span class="hidden-xs"><?php if(!empty($current_user_details->user_detail->first_name)) { echo $current_user_details->user_detail->first_name.' '.$current_user_details->user_detail->last_name; } else { echo $user_data['username']; } ?></span>
        </a>
        <ul class="dropdown-menu">
          <!-- User image -->
          <li class="user-header">
            ...
            <p>
              <?php if(!empty($current_user_details->user_detail->first_name)) { echo $current_user_details->user_detail->first_name.' '.$current_user_details->user_detail->last_name; } else { echo $user_data['username']; } ?>
              <small><?=$current_user_details->Role->name?></small>
            </p>
          </li>
          <!-- Menu Body -->
          <li class="user-body">
          ...
          <li class="user-footer">
            <div class="pull-left">
              ...
              <?= $this->Html->link(__('Profile'), ['controller' => 'users', 'action' => 'profile'], array('class'=>'btn btn-default btn-flat')) ?>
            </div>
            <div class="pull-right">
              <?= $this->Html->link(__('Sign out'), ['controller' => 'users', 'action' => 'logout'], array('class'=>'btn btn-default btn-flat')) ?>
            </div>
          </li>
        </ul>
      </li>
